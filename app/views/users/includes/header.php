...
<head>
  ...
  <!-- Bootstrap -->
  <link href="<?php echo URLROOT ?>/public/assets/users/plugins/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
  <!-- Font Awesome -->
  <link href="<?php echo URLROOT ?>/public/assets/users/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet">
  <!-- Owl Carousel -->
  <link href="<?php echo URLROOT ?>/public/assets/users/plugins/slick-carousel/slick/slick.css" rel="stylesheet">
  <link href="<?php echo URLROOT ?>/public/assets/users/plugins/slick-carousel/slick/slick-theme.css" rel="stylesheet">
  <!-- Fancy Box -->
  <link href="<?php echo URLROOT ?>/public/assets/users/plugins/fancybox/jquery.fancybox.pack.css" rel="stylesheet">
  <link href="<?php echo URLROOT ?>/public/assets/users/plugins/jquery-nice-select/css/nice-select.css" rel="stylesheet">
  <link href="<?php echo URLROOT ?>/public/assets/users/plugins/seiyria-bootstrap-slider/dist/css/bootstrap-slider.min.css" rel="stylesheet">
  <!-- CUSTOM CSS -->
